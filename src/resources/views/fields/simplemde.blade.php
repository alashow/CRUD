...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @push('crud_fields_styles')
        <link rel="stylesheet" href="{{ asset('vendor/backpack/simplemde-markdown-editor/dist/simplemde.min.css' }}">
        <style type="text/css">
    ...
    @push('crud_fields_scripts')
        <script src="{{ asset('vendor/backpack/simplemde-markdown-editor/dist/simplemde.min.css' }}"></script>
    @endpush
