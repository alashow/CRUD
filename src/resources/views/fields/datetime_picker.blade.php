...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <link rel="stylesheet" href="{{ asset('vandor/backpack/bootsrap-datetimepicker/css/bootstrap-datetimepicker.min.css') }}" />
    @endpush
    ...
    <script type="text/javascript" src="{{ asset('vandor/backpack/bootsrap-datetimepicker/js/bootstrap-datetimepicker.min.js') }}"></script>
